...
const { getDetalles, createDetalle, updateDetalle, deleteDetalle } = require('../controllers/detalleConductorController');
const { authenticate, authorize } = require('../middleware/auth');

const router = express.Router();

router.get('/', authenticate, authorize([16]), getDetalles); // Cambia el permiso según corresponda
