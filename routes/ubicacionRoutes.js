...
router.post('/', authenticate, authorize([17]), createUbicacion); // Crear ubicación
router.put('/:id', authenticate, authorize([17]), updateUbicacion); // Actualizar ubicación
router.delete('/:id', authenticate, authorize([17]), deleteUbicacion); // Eliminar ubicación
